...
Flat.create!(
  name: 'The Muse Haus II - Balcony Room',
  address: '288 Kew Road, London TW9',
  description: 'Warm and cosy place to stay. Possible to have early check in (not garantee) if you communicate with them before your arrival. Very well equipped kitchen!
',
  price_per_night: 75,
  number_of_guests: 3
)
